...
import Sandra1 from "../img/shop/sandra_1.webp";
import Sandra2 from "../img/shop/sandra_2.webp";
import Sandra3 from "../img/shop/sandra_3.webp";
import Sandra4 from "../img/shop/sandra_4.webp";
    ...
    >
      <div className="container-editorial">
        ...
        >
          ...
          <h1 className="h1 mb-5 text-[2.85rem] sm:text-[3.5rem] lg:text-[4.5rem]">{t("shop")}</h1>
          <div className="divider-line mb-6" />
          <p className="body-copy mx-auto mb-3 max-w-xl">{t("shop_description_1")}</p>
          <p className="body-copy mx-auto mb-3 max-w-xl">{t("shop_description_2")}</p>
          <p className="mx-auto mb-8 max-w-lg font-primary text-xl italic text-blush-deep lg:text-2xl">
            {t("shop_description_4")}
          </p>
          <Link to="/shop/products" className="btn-blush" data-test="visitProductsButton">
        ...
        >
          <p className="body-copy mx-auto mb-5 max-w-lg">{t("shop_description_3")}</p>
